...
const AddModal = ({ show, onDeleteClick, onCloseClick }) => {
  return (
    <Modal size="sm" isOpen={modal} toggle={toggle}>
	<ModalHeader tag="h4"> "Add User"
                    </ModalHeader>
      <div className="modal-content">
        <ModalBody className="px-4 py-5 text-center">
          ...
          <p className="text-muted font-size-16 mb-4">Are you sure you want to permanently delete the record.</p>
